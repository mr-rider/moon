...
# Number of loops
NUM_LOOPS = 4100
# (x,y) coordinates of CSM
Ro_X = 0
Ro_Y = -85
# vectors of velocity applided by the third stage of the Saturn V rocket
Vo_X = 485 #485
Vo_Y = 0
...
class GravSys():
    ...
    def sim_loop(self):
        """Loop bodies in list through time steps."""
...
class Body(Turtle):
    ...
    def __init__(self, mass, start_loc, vel, gravsys, shape):
        ...
        self.pendown() # Uncomment to draw path behind objectt
